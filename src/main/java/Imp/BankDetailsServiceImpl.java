...
public class BankDetailsServiceImpl {
	...
	public String addV(String AcountNumber,String BankName,  String userID,String userName,String Amount) {
        ...
        try {
        	ps = con.prepareStatement("INSERT INTO customeraccdetails (userID,userName, Amount,AcountNumber,BankName) VALUES (?,?,?,?,?)");
	...
	public String editV(String userID,String userName,String Amount)  {
	        ...
	        try {
	        	ps = con.prepareStatement("UPDATE customeraccdetails SET  userName= ?, Amount= ? WHERE userID = ?");
	...
	public String deleteV(String userID) {
        ...
        try {
        	ps = con.prepareStatement("DELETE FROM customeraccdetails  WHERE userID = ?");
            ps.setString(1, userID);
