...
public class RoiApprovalMailLink {

	/*
	 * private static final String FROM_EMAIL = "shaiknazma473@gmail.com"; //
	 * Replace with your Gmail address private static final String FROM_PASSWORD =
	 * "mgnu dsuv psry clud"; // Replace with your Gmail app password
	 */
	...
	public static void sendLinkEmail(String toEmail,String ReferredUserID,String ReferrerName) {
		...
		String subject = "Trade System ROI Program.";
		String body = "Hi"+  ReferrerName + '\n'
				+ "Please find the RoI Status APPROVAL link for Amount in our trading system. "
				+ "http://localhost:8083/trading/roi_user.jsp?userid="+ReferredUserID;
