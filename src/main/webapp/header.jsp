...
<script>
console.log("Welcome to Header jquery-3.2.1.min.js");
</script>
    <!-- Bootstrap Core JS -->
    <script src="js/popper.min.js"></script>
    <script>
console.log("Welcome to Header js/popper.min.js");
</script>
    <script src="js/bootstrap.min.js"></script>
  <script>
console.log("Welcome to Header js/bootstrap.min.js");
</script>
    <!-- Slimscroll JS -->
    <script src="js/jquery.slimscroll.min.js"></script>
<script>
console.log("Welcome to Header js/jquery.slimscroll.min.js");
</script>
    <!-- Select2 JS -->
    <script src="js/select2.min.js"></script>

<script>
console.log("Welcome to Header js/select2.min.js");
</script>

    <!-- Datetimepicker JS -->
    <script src="js/moment.min.js"></script>
    <script>
console.log("Welcome to Header js/moment.min.js");
</script>
    
    <script src="js/bootstrap-datetimepicker.min.js"></script>
 <script>
console.log("Welcome to Header js/bootstrap-datetimepicker.min.js");
</script>
    <!-- Custom JS -->
